...
namespace PharmacuticalE_Commerce.Controllers
{
	public class UserAuthController : Controller
	{
		...
		public UserAuthController(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<IdentityRole> roleManager, IUserRepository userRepository, ICartRepository cartRepository)
		{
		...
		{
			var user = await _userManager.FindByIdAsync(id);
			var carts = await _cartRepository.GetCartsByUserAsync(user.Id);
