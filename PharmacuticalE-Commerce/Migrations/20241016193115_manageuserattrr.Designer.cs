...
namespace PharmacuticalE_Commerce.Migrations
{
    ...
    [Migration("20241016193115_manageuserattrr")]
    partial class manageuserattrr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorInPrescription", b =>
                {
                    ...
                    b.HasKey("PrescriptionId", "DoctorId")
                        .HasName("PK__DoctorIn__0E02B463C56294AE");

                    b.HasIndex(new[] { "DoctorId" }, "IX_DoctorInPrescription_doctorId");

                    b.ToTable("DoctorInPrescription", (string)null);
                });
            ...
            modelBuilder.Entity("PharmacuticalE_Commerce.Models.Doctor", b =>
                {
                    b.Property<int>("DoctorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("DoctorId")
                        .HasName("PK__Doctor__722484769DF35E54");
            ...
            modelBuilder.Entity("PharmacuticalE_Commerce.Models.Pav", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int")
                        .HasColumnName("productId");
                    ...
                    b.HasKey("ProductId", "AttributeId")
                        .HasName("PK__PAV__3D2B51558DCFC313");

                    b.HasIndex(new[] { "AttributeId" }, "IX_PAV_attributeId");

                    b.ToTable("PAV", (string)null);
                });

            modelBuilder.Entity("PharmacuticalE_Commerce.Models.Prescription", b =>
                {
                    b.Property<int>("PrescriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("PrescriptionId")
                        .HasName("PK__Prescrip__7920FC2498C9F50F");

                    b.HasIndex(new[] { "CartId" }, "IX_Prescription_cartId");

                    b.HasIndex(new[] { "EmployeeId" }, "IX_Prescription_employeeId");
            ...
            modelBuilder.Entity("PharmacuticalE_Commerce.Models.ProductAttribute", b =>
                {
                    b.Property<int>("AttributeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("AttributeId")
                        .HasName("PK__ProductA__03B803F048206992");

                    b.ToTable("ProductAttribute", (string)null);
                });

            modelBuilder.Entity("PharmacuticalE_Commerce.Models.ProductPrice", b =>
                {
                    ...
                    b.HasKey("PriceId")
                        .HasName("PK__ProductP__366E4CC285ECEDD9");

                    b.HasIndex(new[] { "ProductId" }, "IX_ProductPrice_productId");
            ...
            modelBuilder.Entity("PharmacuticalE_Commerce.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasKey("ShoppingCartId")
                        .HasName("PK__Shopping__21DFC906F465567E");

                    b.HasIndex(new[] { "CartId" }, "IX_ShoppingCart_cartId");
            ...
            modelBuilder.Entity("DoctorInPrescription", b =>
                {
                    b.HasOne("PharmacuticalE_Commerce.Models.Doctor", null)
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .IsRequired()
                        .HasConstraintName("FK__DoctorInP__docto__5CD6CB2B");

                    b.HasOne("PharmacuticalE_Commerce.Models.Prescription", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PharmacuticalE_Commerce.Models.Pav", b =>
                {
                    b.HasOne("PharmacuticalE_Commerce.Models.ProductAttribute", "Attribute")
                        .WithMany("Pavs")
